...
# docker-config.single-gpu-only.sh
...
echo "#"
echo "##"
echo "## sd-forge-webui-docker - docker-config.single-gpu-only.sh script initiated"
echo "##"
echo "## Edit the configuration (single gpu only)"
echo "##"
echo "#"

nano ${GIT_ROOT}/docker/compose_files/docker-compose.single-gpu.nvidia.yaml
