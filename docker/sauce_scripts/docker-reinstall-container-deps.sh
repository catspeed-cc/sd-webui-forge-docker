...
echo "#"
echo "##"
echo "## sd-forge-webui-docker docker-reinstall-container-deps.sh script initiated"
echo "##"
echo "## reinstalls container dependencies (container must be running, better to destroy/init)"
echo "##"
echo "#"
...
echo ""
echo "all container(s) have reinstalled their dependencies"
echo ""
