...
# docker-config.multi-gpu-only.sh
...
echo "#"
echo "##"
echo "## sd-forge-webui-docker docker-config.multi-gpu-only.sh script initiated"
echo "##"
echo "## Edit the configuration (single of multi gpu only)"
echo "##"
echo "#"

nano ${GIT_ROOT}/docker/compose_files/docker-compose.multi-gpu.nvidia.yaml
