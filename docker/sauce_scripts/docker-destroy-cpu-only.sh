...
# docker-destroy-cpu-only.sh: stop & remove all sd-forge containers
...
echo "#"
echo "##"
echo "## sd-forge-webui-docker docker-destroy-cpu-only.sh script initiated"
echo "##"
...
docker compose -f ${DOCKER_COMPOSE_DIR}/docker-compose.cpu.only.yaml down
