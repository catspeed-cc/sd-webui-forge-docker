...
export TORCH_COMMAND=python -m pip install torch==2.3.1+cu128 torchvision==0.18.1+cu128 torchaudio==2.3.1+cu128 --index-url https://download.pytorch.org/whl/cu128
